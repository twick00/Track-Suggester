...
function appendQuestions() {
    for (var i = 0; i < questionInfo.length; i++) {
        ...
        for (var o = 0; o < questionInfo[i].answer.length; o++) {
            ...
            $("input:last").attr("name", i); //Simplistic unique IDs
...
$(document).ready(function () {
    ...
    $("#dark-theme").click(function () {
        ...
        $(".jumbotron").removeClass("light-panel-body")
        $(".jumbotron").addClass("dark-panel-body")
        $("#dark-theme").hide();
        $("#light-theme").show();
    });
    ...
    $("#light-theme").click(function () {
        ...
        $(".jumbotron").removeClass("dark-panel-body")
        $(".jumbotron").addClass("light-panel-body")
        $("#light-theme").hide();
        $("#dark-theme").show();
    });
